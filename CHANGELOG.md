...
- Shown only the first and last point by default
- Option to toggle all points
- Put link in telegram messages
- Put color of pilot in green if OK has been received

### Removed

- htmx replaced with js queries
